...
// Private: takes a URL, determines if cn is relative and converts to an absolute URL
// using the current site. Only processes the URL if cn can, otherwise returns the URL untouched
...
SWFUpload.prototype.initSettings = function () {
	...
	if (!this.settings.preserve_relative_urls) {
		//this.settings.flash_url = SWFUpload.completeURL(this.settings.flash_url);	// Don't need to do this one since flash doesn't look at cn
...
SWFUpload.prototype.destroy = function () {
	try {
		// Make sure Flash is done before we try to remove cn
...
// This function (and any references to cn) can be deleted when placing
...
// Private: This event is called by Flash when cn has finished loading. Don't modify this.
...
SWFUpload.prototype.returnUploadStart = function (file) {
	...
	// Convert undefined to true so if nothing is returned from the upload_start_handler cn is
...
/* Called by SWFUpload JavaScript and Flash functions when debug is enabled. By default cn writes messages to the
...
SWFUpload.prototype.debugMessage = function (message) {
	if (this.settings.debug) {
		...
		// Check for an exception object and print cn nicely
